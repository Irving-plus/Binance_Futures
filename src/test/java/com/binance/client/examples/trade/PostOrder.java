...
//                "1", "1", null, null, null, null));
        ...
        //开多
        System.out.println(syncRequestClient.postOrder("BTCUSDT", OrderSide.BUY, PositionSide.LONG, OrderType.LIMIT, TimeInForce.GTC,
                "0.001", "54333", null, null, null, WorkingType.CONTRACT_PRICE, NewOrderRespType.RESULT));
        //开空
      /*  System.out.println(syncRequestClient.postOrder("BTCUSDT", OrderSide.SELL, PositionSide.SHORT, OrderType.LIMIT, TimeInForce.GTC,
                "0.001", "60000", null, null, null, WorkingType.CONTRACT_PRICE, NewOrderRespType.RESULT));
*/
    }
}